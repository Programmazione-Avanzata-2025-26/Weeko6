...
def main():
    # Usando il pattern DAO, l'applicazione
    # principale non deve conoscere i dettagli
    # del database, nemmeno sapere della sua
    # esistenza: l'accesso al database sarà
    # mediato dalla classe DAO
    users_dao = UsersDAO()

    # Usando il pattern DAO, posso interagire
    # con il database ignorandone l'esistenza

    # Mi basta chiamare i metodi messi a disposizione
    # dalla classe UsersDAO

    #Ad esempio, per inserire un nuovo utente

    # Passando i parametri che servono per specificare l'utente ...
